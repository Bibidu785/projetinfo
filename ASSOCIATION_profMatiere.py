...
# Demander à l'utilisateur d'entrer les matières
nb_matieres = int(input("Entrez le nombre de matières à ajouter : "))
for _ in range(nb_matieres):
    # Demander à l'utilisateur d'entrer le nom de la matière
